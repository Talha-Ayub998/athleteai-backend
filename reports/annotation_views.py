...
from reports.annotation_utils import (
    ...
    missing_previous_match_results,
...
class AnnotationEventCreateView(APIView):
    ...
    def post(self, request, session_id):
        ...
        missing_previous = missing_previous_match_results(session, match_number)
        if missing_previous:
            return Response(
                {
...
class AnnotationFinalizeView(APIView):
    ...
    def post(self, request, session_id):
        ...
        stats_counters, match_numbers = aggregate_stats_rows(events)
